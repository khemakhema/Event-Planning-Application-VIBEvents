...
if($services === "") {
//$query = "SELECT * FROM VendorData WHERE companyName = (SELECT DISTINCT owner FROM Location WHERE location_name = '$location') AND eventsServiced='$type' group by companyName";
$query = "SELECT * FROM VendorData WHERE eventsServiced='$type'";
}
else {
...
$query = "SELECT * FROM VendorData WHERE servicesOffered='$services' group by companyName";
}
$result = $this->connection->query($query);
